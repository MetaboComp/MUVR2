...
#' @importFrom ggplot2 aes after_stat annotate coord_cartesian element_blank element_text facet_wrap geom_abline geom_boxplot geom_histogram geom_hline geom_line geom_point geom_segment geom_text geom_tile geom_vline ggplot guides labs scale_alpha_manual scale_colour_gradient scale_colour_gradientn scale_colour_manual scale_fill_manual scale_linetype_manual scale_shape_manual scale_x_continuous scale_x_log10 scale_y_continuous scale_y_reverse sec_axis theme theme_bw
